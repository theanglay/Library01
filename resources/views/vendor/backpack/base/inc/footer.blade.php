...
{{--      {{ trans('backpack::base.handcrafted_by') }} <a target="_blank" rel="noopener" href="{{ config('backpack.base.developer_link') }}">{{ config('backpack.base.developer_name') }}</a>.--}}
      ...
      {{ trans('backpack::base.powered_by') }} <a target="_blank" rel="noopener" href="https://www.youtube.com/watch?v=QBNMMwL8d_s"> Library  Management  System Database Project @group 5</a>.
      @endif
    </div>
@endif
