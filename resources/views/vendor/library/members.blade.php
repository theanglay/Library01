                    ...
                    <table id="table_id" class="display school-table" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <?php
                                        $student_name = \App\SmStudent::find($value->student_staff_id);
                                        $parent_name = \App\SmParent::find($value->student_staff_id);
                                        $staff_name = \App\SmStaff::find($value->student_staff_id);
...
//                                        if(!empty($staff_name->full_name) && !empty($staff_name->full_name)) { echo $staff_name->full_name; }
                                ...
                                <td>
                                 <?php
                                 if($value->member_type == '2'){
                                    if(!empty($student_name->email)) {   echo $student_name->email;}
