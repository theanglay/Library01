...
{{--                                <?php--}}
{{--                                    $visitors = \App\SmVisitorLibrary::where('student_id',$student->student_id)->get();--}}
{{--                                ?>--}}
{{--                                @foreach($visitors as $visitor)--}}
{{--                                    @if($visitor != NULL)--}}
{{--                                        <tr>--}}
{{--                                            <td>{{@$visitor->student->roll_no}}</td>--}}
{{--                                            <td>{{@$visitor->student->full_name}}</td>--}}
{{--                                            <td>{{@$visitor->date}}</td>--}}
{{--                                            <td>{{@$visitor->start_time}}</td>--}}
{{--                                            <td>{{@$visitor->end_time}}</td>--}}
{{--                                            <td>{{@$visitor->student->date_of_birth != ""? App\SmGeneralSettings::DateConvater($visitor->student->date_of_birth):''}}</td>--}}
{{--                                            <td>{{@$visitor->major->major_name}}</td>--}}
{{--                                            <td>{{@$visitor->faculty->faculty_name}}</td>--}}
{{--                                            <td>{{@$visitor->student->mobile}}</td>--}}
{{--                                            <td>--}}
{{--                                                <div class="dropdown">--}}
...
{{--                                                            <a class="dropdown-item" href="{{route('student_list_edit', [$visitor->id])}}">@lang('lang.edit')</a>--}}
{{--                                                        @endif--}}
{{--                                                        @if(in_array(80, App\GlobalVariable::GlobarModuleLinks()) || Auth::user()->role_id == 1 )--}}
{{--                                                            <a class="dropdown-item" data-toggle="modal" data-target="#deleteStudentGroupModal{{$visitor->id}}"--}}
...
{{--                                            </td>--}}
{{--                                        </tr>--}}
{{--                                        <div class="modal fade admin-query" id="deleteStudentGroupModal{{$visitor->id}}" >--}}
...
{{--                                                            <a href="{{route('student_list_delete', [$visitor->id])}}"><button class="primary-btn fix-gr-bg" type="submit">@lang('lang.delete')</button></a>--}}
{{--                                                        </div>--}}
{{--                                                    </div>--}}
