                ...
                <div class="col-lg-3">
                    ...
                    <div class="student-meta-box mt-30">
                        ...
                        @if(@$memberDetails->member_type == 2)
                            <img class="student-meta-img img-100" src="{{asset(@$getMemberDetails->student->student_photo)}}" alt="">
                        @else
                            <img class="student-meta-img img-100" src="{{asset(@$getMemberDetails->staffDetails->staff_photo)}}" alt="">
                        @endif
                        <div class="white-box">
                            @if($memberDetails->member_type == 2)
              ...
              <strong>{{ $errors->first('book_id') }}</strong>
                                            ...
                                            <div class="col-lg-12 mb-20">
                                                <div class="no-gutters input-right-icon">
                                                    <div class="col">
                                                        <div class="input-effect">
                                                            <label for="">@lang('lang.due_date')</label>
                  ...
                  <strong>{{ $errors->first('due_date') }}</strong>
                                            ...
                                            <input type="hidden" name="member_id" value="{{@$memberDetails->student_id}}">
                                        ...
                                        <tr>
                                            ...
                                            @if($value->issue_status == 'I')
                                                @if($value->remaining_days != 0)
                                                    @if($current_date->gt($value->due_date))
                                                        <td style="color:red">
                                                            -{{$value->remaining_days}} days
                                                        </td>
                                                    @else
                                                        @if($value->remaining_days > 0 && $value->remaining_days <= 3 )
                                            ...
                                            @endif
                                            <td>
                                                @if($current_date->gt($value->due_date) && $value->remaining_days !=0)
                                                    @if($value->issue_status == 'I')
                                                    ...
                                                    @else
                                                        <div style="width:265px;">
                                                            ...
                                                            <div style="float: right; width: 150px">
                                                                <button class="primary-btn small bg-warning text-white border-0">LATE {{$value->remaining_days}} days</button>
                                                            </div>
                                                        </div>
